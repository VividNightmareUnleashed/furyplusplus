...
FuryPlusPlus 1.2.1 is tested against VRCFury 1.1394.0. On the reference avatar it reduced a warm
...
- Behavior-changing modules: **VRCFury 1.1394.0 exactly**
...
installed VRCFury version is exactly `1.1394.0`. Each module also checks its own target signatures
...
4. Wait for the Editor to recompile. The Console should report
   `[FuryPlusPlus] Ready: 29/29 modules installed for VRCFury 1.1394.0, 15 superseded`.
